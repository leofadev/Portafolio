                ...
                <div className="row">
                    <div className="col-sm-12 col-md 6 col-lg-4">
                        <div className="container">
                            <img className='rounded-5' src="https://lh3.googleusercontent.com/d/1L08irLSeQMsoQPDa-j7JQJSR045Gq9Yk=w250?authuser=0" alt="foto" />  
                        </div>
                    </div>
                        <div className="col-sm-12 col-md-6 col-lg-8" data-aos="fade-up" data-aos-duration="1300">
                            <div className="container">
                                <h2>LeofaDev</h2>
                                <p>
                                ...
                                <div className="social-buttons">
                                    <a href="https://github.com/leofadev" className="social-button github">
                                    <svg
                                    ...
                                    <a href="https://www.linkedin.com/in/leonardo-pinto-b72b1a24a" className="social-button linkedin">
                                    <svg
                                        viewBox="0 -2 44 44"
                                        version="1.1"
                                        xmlns="http://www.w3.org/2000/svg"
